...
Game::Game()
    : mWindow(sf::VideoMode(1280, 768), "Cool title"), mFont(), mWorld(mWindow),
      textFPS(), framesCount(0), mIsPaused(false), statTime(sf::seconds(0)),
...
void Game::update(sf::Time timedelta) { mWorld.update(timedelta); }
